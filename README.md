...
## TODO
% to-do %
проверки запихнуть в шаблоны
классы в отдельный файл .h .cpp
структура множества труб anotrdt (списо)
переопределение cin cout чтобы при выводе класса можно было выводить все его параметры
...
Основные НОВЫЕ моменты:
    ...
    Простые классы с базовым разделением на private/public
    Базовые методы для работы с данными
    Класс Manager для управления объектами
    Реализован поиск по заданным критериям
